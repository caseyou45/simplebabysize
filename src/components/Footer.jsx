...
function Footer(props) {
  ...
  return (
    <footer>
      ...
      <TwitterShareButton url={url} quote={title} className="icon">
        <TwitterIcon size={32} />
      </TwitterShareButton>
      <RedditShareButton url={url} quote={title} className="icon">
        <RedditIcon size={32} />
      </RedditShareButton>
      <EmailShareButton url={url} quote={title} className="icon">
        <EmailIcon size={32} />
      </EmailShareButton>
